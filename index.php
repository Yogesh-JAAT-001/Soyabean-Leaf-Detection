...
<head>
    ...
    <title>Soyabean Leaf Detection Using Inception ResNet V2 | PBL Presentation 2026</title>
...
<body onload="startTimer()">
    ...
    <main class="max-w-6xl mx-auto px-6 pt-48 pb-32 space-y-32">
        ...
        <section class="text-center">
            <div class="inline-block px-4 py-1 border border-slate-800 rounded-full text-slate-500 text-[10px] font-mono mb-6 uppercase tracking-widest">ID: 2427030798</div>
            <h1 class="text-6xl md:text-7xl font-extrabold mb-8 uppercase leading-tight"><span class="gradient-text uppercase">Soyabean Leaf Detection Using Inception ResNet V2</span></h1>
        ...
        <section id="problem" class="grid md:grid-cols-2 gap-12 items-stretch">
            <div class="glass p-10 rounded-[2.5rem] flex flex-col justify-center border-l-4 border-blue-600">
                ...
                <p class="text-slate-400 leading-relaxed text-justify">Soybean crops are affected by multiple leaf diseases which reduce productivity. Manual detection is time-consuming and not always accurate.</p>
            </div>
            <div class="space-y-6">
                <div class="glass p-7 rounded-3xl border-r-4 border-blue-500/50">
                    ...
                    <p class="text-sm text-slate-500 italic">Existing systems rely on traditional methods which are less accurate and not robust.</p>
                </div>
                <div class="glass p-7 rounded-3xl border-r-4 border-purple-500/50">
                    ...
                    <p class="text-sm text-slate-500 italic">There is a need for an automated and efficient system that can detect diseases using deep learning techniques.</p>
                </div>
            </div>
        </section>
        ...
        <section id="methodology" class="space-y-12">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="glass p-8 rounded-3xl text-center">
                    ...
                    <p class="text-sm text-slate-500">Zenodo soybean dataset with 8 classes and thousands of labeled images.</p>
                </div>
                <div class="glass p-8 rounded-3xl text-center">
                    ...
                    <p class="text-sm text-slate-500">InceptionResNetV2 with transfer learning and SE (attention) module.</p>
                </div>
                <div class="glass p-8 rounded-3xl text-center border-2 border-green-500/20 bg-green-500/5">
                    ...
                    <a href="#" target="_blank" class="px-6 py-2 bg-green-600 rounded-full text-[10px] font-black hover:bg-green-500 transition shadow-lg shadow-green-900/40">VIEW CODE / DEMO</a>
                </div>
            </div>
        </section>
            ...
            <div class="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="space-y-6">
                    <div class="p-6 rounded-2xl bg-white/5 flex justify-between items-center border border-white/10 shadow-inner">
                        <span class="text-slate-400 font-bold uppercase text-xs tracking-widest">Model Accuracy</span>
                        <span class="text-blue-400 font-mono font-black text-3xl">77%</span>
                    </div>
                    <p class="text-slate-500 text-sm italic text-justify leading-relaxed">The model achieved an accuracy of approximately 77%, demonstrating its capability to classify soybean leaf diseases effectively.</p>
                </div>
            </div>
        </section>
        ...
        <section id="team" class="text-center pt-10 border-t border-slate-900">
            ...
            <div class="flex flex-wrap justify-center gap-10">
                <div class="glass px-12 py-8 rounded-[2rem] border-b-4 border-blue-600">
                    ...
                    <p class="font-black text-xl text-slate-100">Dr Tapan Kumar Dey</p>
                </div>
                <div class="glass px-12 py-8 rounded-[2rem] border-b-4 border-slate-700">
                    <p class="text-[9px] font-bold text-slate-400 mb-2 uppercase tracking-widest">Team Members</p>
                    <p class="font-black text-xl text-slate-100">Yogesh Kumar<br>Hemant Mahala</p>
                    <p class="text-[10px] text-slate-500 mt-1">2427030798<br>2427030803</p>
                </div>
            </div>
        </section>
    </main>
